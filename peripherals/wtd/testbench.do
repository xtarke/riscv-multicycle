...
add wave -height 15 -divider "Watchdog"
add wave -label wtd_mode -radix unsigned /watchdog/wtd_mode
add wave -label prescaler -radix unsigned /watchdog/prescaler
add wave -label top_counter -radix unsigned /watchdog/top_counter

add wave -label counter -radix unsigned /watchdog/counter
add wave -label wtd_reset -radix unsigned /watchdog/wtd_reset
add wave -label wtd_hold -radix unsigned /watchdog/wtd_hold
add wave -label wtd_out -radix unsigned /wtd_out
add wave -label wtd_interrupt -radix unsigned /watchdog/wtd_interrupt
