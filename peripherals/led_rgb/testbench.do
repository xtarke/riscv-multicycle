...
vcom ./peripherals/led_rgb/controlador.vhd
vcom ./peripherals/led_rgb/rgb_mapeado.vhd
vcom ./core/csr.vhd
vcom ./core/core.vhd
...
add wave -height 15 -divider "RGB LED"
add wave -label led_endereço /led_controller_inst/daddress
add wave -label led_dcsel /led_controller_inst/dcsel
add wave -label led_d_we /led_controller_inst/d_we
add wave -label start /led_controller_inst/ctrl_start
add wave -label reset /led_controller_inst/ctrl_restart
add wave -label led_data_w -radix hex /led_controller_inst/ddata_w
add wave -label din /led_controller_inst/ctrl_din
add wave -label dout /ARDUINO_IO(8)
