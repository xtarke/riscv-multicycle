...
add wave -height 15 -divider "Servo Motor"
add wave -radix binary   -label pwm /pwm
# add wave -radix binary   -label rotate /rotate
add wave -radix binary   -label rotate_tb /rotate_tb
