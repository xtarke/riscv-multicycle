...
add wave -height 15 -divider "LCD"
add wave -label lcd_data -radix unsigned /lcd/lcd_data
add wave -label lcd_rs -radix binary /lcd/lcd_rs
add wave -label lcd_e -radix binary /lcd/lcd_e
