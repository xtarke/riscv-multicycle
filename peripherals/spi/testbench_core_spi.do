...
add wave -radix hex -label  i_clk       /clk
add wave -radix hex -label  i_rst       /rst
add wave -radix hex -label  i_tx_start  /i_tx_start
add wave -radix hex -label  i_data      /data_in
add wave -radix hex -label  i_miso      /ARDUINO_IO(10)
add wave -radix hex -label  o_data      /data_out
add wave -radix hex -label  o_tx_end    /o_tx_end
add wave -radix hex -label  o_sclk      /ARDUINO_IO(8)
add wave -radix hex -label  o_ss        /ARDUINO_IO(9)
add wave -radix hex -label  o_mosi      /ARDUINO_IO(10)
