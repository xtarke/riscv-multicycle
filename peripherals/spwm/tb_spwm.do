...
vcom ../../peripherals/spwm/spwm.vhd
vcom ../../core/csr.vhd
vcom ../../core/core.vhd
...
add wave -height 15 -divider "SPWM"
add wave -label sine_freq -radix unsigned /spwm/sine_freq
...
add wave -label mod_count -radix signed /spwm/mod_count
