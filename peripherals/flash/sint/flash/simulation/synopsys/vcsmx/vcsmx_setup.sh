...
# ACDS 20.1 720 linux 2021.08.30.08:57:20
...
# ----------------------------------------
# If flash is one of several IP cores in your
...
TOP_LEVEL_NAME="flash"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/rgnagel/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/flash.vhd"                                                                 
fi
