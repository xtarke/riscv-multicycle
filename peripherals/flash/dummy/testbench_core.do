...
vlib work
vcom $CORE_ROOT_DIR/memory/iram_quartus.vhd
vcom $CORE_ROOT_DIR/memory/dmemory.vhd
vcom $CORE_ROOT_DIR/memory/instructionbusmux.vhd
vcom $CORE_ROOT_DIR/memory/databusmux.vhd
vcom $CORE_ROOT_DIR/memory/iodatabusmux.vhd
vcom $CORE_ROOT_DIR/alu/alu_types.vhd
vcom $CORE_ROOT_DIR/alu/alu.vhd
vcom $CORE_ROOT_DIR/alu/m/division_functions.vhd
vcom $CORE_ROOT_DIR/alu/m/quick_naive.vhd
vcom $CORE_ROOT_DIR/alu/m/M_types.vhd
vcom $CORE_ROOT_DIR/alu/m/M.vhd
vcom $CORE_ROOT_DIR/decoder/decoder_types.vhd
vcom $CORE_ROOT_DIR/decoder/iregister.vhd
vcom $CORE_ROOT_DIR/decoder/decoder.vhd
vcom $CORE_ROOT_DIR/registers/register_file.vhd
vcom $CORE_ROOT_DIR/peripherals/gpio/gpio.vhd
vcom $CORE_ROOT_DIR/peripherals/gpio/led_displays.vhd
vcom $CORE_ROOT_DIR/peripherals/timer/Timer.vhd
vcom $CORE_ROOT_DIR/core/csr.vhd
vcom $CORE_ROOT_DIR/core/core.vhd
vcom $CORE_ROOT_DIR/core/txt_util.vhdl
vcom $CORE_ROOT_DIR/core/trace_debug.vhd
vcom $CORE_ROOT_DIR/peripherals/flash/dummy/flash_bus.vhd
vcom testbench_core.vhd
...
add wave -height 15 -divider "Flash Bus"
add wave -label ddata_r_flash -radix hex /ddata_r_flash
