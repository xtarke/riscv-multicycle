...
add wave -label baud_reg  -radix hex /testbench/baud_reg
add wave -label clk_out   -radix binary /testbench/clk_out
add wave -label stuff     -radix binary /testbench/stuff_nxt_bit_out
add wave -label tx_out    -radix binary /testbench/can_tx
