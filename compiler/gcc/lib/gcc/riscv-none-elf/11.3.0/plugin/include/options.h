...
enum opt_code
{
  ...
  OPT_list = 1676,                           /* -list */
  OPT_mabi_ = 1677,                          /* -mabi= */
  OPT_malign_data_ = 1678,                   /* -malign-data= */
  OPT_march_ = 1679,                         /* -march= */
  OPT_mbig_endian = 1680,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1681,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1682,                       /* -mcmodel= */
  OPT_mcpu_ = 1683,                          /* -mcpu= */
  OPT_mdiv = 1684,                           /* -mdiv */
  OPT_mexplicit_relocs = 1685,               /* -mexplicit-relocs */
  OPT_mfdiv = 1686,                          /* -mfdiv */
  OPT_misa_spec_ = 1687,                     /* -misa-spec= */
  OPT_mlittle_endian = 1688,                 /* -mlittle-endian */
  OPT_mplt = 1689,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1690,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1691,                         /* -mrelax */
  OPT_mriscv_attribute = 1692,               /* -mriscv-attribute */
  OPT_msave_restore = 1693,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1694,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1695,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1696, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1697,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1698,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1699,                  /* -mstrict-align */
  OPT_mtune_ = 1700,                         /* -mtune= */
  OPT_n = 1701,                              /* -n */
  OPT_name_sort = 1702,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1703,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1704,              /* -no-integrated-cpp */
  OPT_no_pie = 1705,                         /* -no-pie */
  OPT_nocpp = 1706,                          /* -nocpp */
  OPT_nodefaultlibs = 1707,                  /* -nodefaultlibs */
  OPT_nolibc = 1708,                         /* -nolibc */
  OPT_nophoboslib = 1709,                    /* -nophoboslib */
  OPT_nostartfiles = 1710,                   /* -nostartfiles */
  OPT_nostdinc = 1711,                       /* -nostdinc */
  OPT_nostdinc__ = 1712,                     /* -nostdinc++ */
  OPT_nostdlib = 1713,                       /* -nostdlib */
  OPT_o = 1714,                              /* -o */
  OPT_objects = 1715,                        /* -objects */
  OPT_p = 1716,                              /* -p */
  OPT_pass_exit_codes = 1717,                /* -pass-exit-codes */
  /* OPT_pedantic = 1718, */                 /* -pedantic */
  OPT_pedantic_errors = 1719,                /* -pedantic-errors */
  OPT_pg = 1720,                             /* -pg */
  OPT_pie = 1721,                            /* -pie */
  OPT_pipe = 1722,                           /* -pipe */
  OPT_print_file_name_ = 1723,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1724,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1725,          /* -print-multi-directory */
  OPT_print_multi_lib = 1726,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1727,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1728,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1729,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1730,               /* -print-prog-name= */
  OPT_print_search_dirs = 1731,              /* -print-search-dirs */
  OPT_print_sysroot = 1732,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1733,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1734,                    /* -print-value */
  OPT_quiet = 1735,                          /* -quiet */
  OPT_r = 1736,                              /* -r */
  OPT_remap = 1737,                          /* -remap */
  OPT_reverse_sort = 1738,                   /* -reverse-sort */
  OPT_s = 1739,                              /* -s */
  OPT_save_temps = 1740,                     /* -save-temps */
  OPT_save_temps_ = 1741,                    /* -save-temps= */
  OPT_shared = 1742,                         /* -shared */
  OPT_shared_libgcc = 1743,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1744,               /* -shared-libphobos */
  OPT_size_sort = 1745,                      /* -size-sort */
  /* OPT_specs = 1746, */                    /* -specs */
  OPT_specs_ = 1747,                         /* -specs= */
  OPT_static = 1748,                         /* -static */
  OPT_static_libasan = 1749,                 /* -static-libasan */
  OPT_static_libgcc = 1750,                  /* -static-libgcc */
  OPT_static_libgfortran = 1751,             /* -static-libgfortran */
  OPT_static_libgo = 1752,                   /* -static-libgo */
  OPT_static_libhwasan = 1753,               /* -static-libhwasan */
  OPT_static_liblsan = 1754,                 /* -static-liblsan */
  OPT_static_libmpx = 1755,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1756,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1757,               /* -static-libphobos */
  OPT_static_libstdc__ = 1758,               /* -static-libstdc++ */
  OPT_static_libtsan = 1759,                 /* -static-libtsan */
  OPT_static_libubsan = 1760,                /* -static-libubsan */
  OPT_static_pie = 1761,                     /* -static-pie */
  /* OPT_std_c__03 = 1762, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1763, */                /* -std=c++0x */
  OPT_std_c__11 = 1764,                      /* -std=c++11 */
  OPT_std_c__14 = 1765,                      /* -std=c++14 */
  OPT_std_c__17 = 1766,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1767, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1768, */                /* -std=c++1z */
  OPT_std_c__20 = 1769,                      /* -std=c++20 */
  OPT_std_c__23 = 1770,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1771, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1772, */                /* -std=c++2b */
  OPT_std_c__98 = 1773,                      /* -std=c++98 */
  OPT_std_c11 = 1774,                        /* -std=c11 */
  OPT_std_c17 = 1775,                        /* -std=c17 */
  /* OPT_std_c18 = 1776, */                  /* -std=c18 */
  /* OPT_std_c1x = 1777, */                  /* -std=c1x */
  OPT_std_c2x = 1778,                        /* -std=c2x */
  /* OPT_std_c89 = 1779, */                  /* -std=c89 */
  OPT_std_c90 = 1780,                        /* -std=c90 */
  OPT_std_c99 = 1781,                        /* -std=c99 */
  /* OPT_std_c9x = 1782, */                  /* -std=c9x */
  OPT_std_f2003 = 1783,                      /* -std=f2003 */
  OPT_std_f2008 = 1784,                      /* -std=f2008 */
  OPT_std_f2008ts = 1785,                    /* -std=f2008ts */
  OPT_std_f2018 = 1786,                      /* -std=f2018 */
  OPT_std_f95 = 1787,                        /* -std=f95 */
  OPT_std_gnu = 1788,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1789, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1790, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1791,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1792,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1793,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1794, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1795, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1796,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1797,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1798, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1799, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1800,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1801,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1802,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1803, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1804, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1805,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1806, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1807,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1808,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1809, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1810, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1811,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1812, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1813, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1814, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1815, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1816, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1817,                     /* -std=legacy */
  OPT_stdlib_ = 1818,                        /* -stdlib= */
  OPT_symbol_ = 1819,                        /* -symbol= */
  OPT_symbolic = 1820,                       /* -symbolic */
  OPT_t = 1821,                              /* -t */
  OPT_time = 1822,                           /* -time */
  OPT_time_ = 1823,                          /* -time= */
  OPT_traditional = 1824,                    /* -traditional */
  OPT_traditional_cpp = 1825,                /* -traditional-cpp */
  OPT_tree_stats = 1826,                     /* -tree-stats */
  OPT_trigraphs = 1827,                      /* -trigraphs */
  OPT_type_stats = 1828,                     /* -type-stats */
  OPT_u = 1829,                              /* -u */
  OPT_undef = 1830,                          /* -undef */
  OPT_v = 1831,                              /* -v */
  OPT_version = 1832,                        /* -version */
  OPT_w = 1833,                              /* -w */
  OPT_wrapper = 1834,                        /* -wrapper */
  OPT_x = 1835,                              /* -x */
  OPT_z = 1836,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
