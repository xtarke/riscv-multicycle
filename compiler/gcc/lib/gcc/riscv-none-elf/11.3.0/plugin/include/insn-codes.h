...
enum insn_code {
  ...
  CODE_FOR_mulditi3 = 346,
  CODE_FOR_umulditi3 = 347,
  CODE_FOR_usmulditi3 = 348,
  CODE_FOR_mulsidi3 = 349,
  CODE_FOR_umulsidi3 = 350,
  CODE_FOR_usmulsidi3 = 351,
  CODE_FOR_movdi = 352,
  CODE_FOR_movsi = 353,
  CODE_FOR_movhi = 354,
  CODE_FOR_movqi = 355,
  CODE_FOR_movsf = 356,
  CODE_FOR_movdf = 357,
  CODE_FOR_cpymemsi = 358,
  CODE_FOR_clear_cache = 359,
  CODE_FOR_movsicc = 360,
  CODE_FOR_movdicc = 361,
  CODE_FOR_condjump = 362,
  CODE_FOR_cbranchqi4 = 363,
  CODE_FOR_cbranchsi4 = 364,
  CODE_FOR_cbranchdi4 = 365,
  CODE_FOR_cbranchsf4 = 366,
  CODE_FOR_cbranchdf4 = 367,
  CODE_FOR_cstoresi4 = 368,
  CODE_FOR_cstoredi4 = 369,
  CODE_FOR_cstoresf4 = 370,
  CODE_FOR_cstoredf4 = 371,
  CODE_FOR_flt_quietsfsi4 = 372,
  CODE_FOR_fle_quietsfsi4 = 373,
  CODE_FOR_flt_quietsfdi4 = 374,
  CODE_FOR_fle_quietsfdi4 = 375,
  CODE_FOR_flt_quietdfsi4 = 376,
  CODE_FOR_fle_quietdfsi4 = 377,
  CODE_FOR_flt_quietdfdi4 = 378,
  CODE_FOR_fle_quietdfdi4 = 379,
  CODE_FOR_indirect_jump = 380,
  CODE_FOR_tablejump = 381,
  CODE_FOR_prologue = 382,
  CODE_FOR_epilogue = 383,
  CODE_FOR_sibcall_epilogue = 384,
  CODE_FOR_return = 385,
  CODE_FOR_eh_return = 386,
  CODE_FOR_sibcall = 387,
  CODE_FOR_sibcall_value = 388,
  CODE_FOR_call = 389,
  CODE_FOR_call_value = 390,
  CODE_FOR_untyped_call = 391,
  CODE_FOR_restore_stack_nonlocal = 392,
  CODE_FOR_get_thread_pointersi = 393,
  CODE_FOR_get_thread_pointerdi = 394,
  CODE_FOR_stack_protect_set = 395,
  CODE_FOR_stack_protect_test = 396,
  CODE_FOR_mem_thread_fence = 397,
  CODE_FOR_atomic_compare_and_swapsi = 398,
  CODE_FOR_atomic_compare_and_swapdi = 399,
  CODE_FOR_atomic_test_and_set = 400
};

const unsigned int NUM_INSN_CODES = 401;
